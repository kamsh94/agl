...
<head>
    ...
    <!--end::Base Path -->
    <meta charset="utf-8" />
    <title>Field Master | Dashboard</title>
                                    ...
                                    <div class="kt-portlet kt-portlet--height-fluid kt-widget19">
                                        <div class="kt-portlet__body kt-portlet__body--fit kt-portlet__body--unfill">
                                            <div class="kt-widget19__pic kt-portlet-fit--top kt-portlet-fit--sides" style="min-height: 300px; background-image: url(/public/assets/media//products/product4.jpg)">
                                                ...
                                                <div class="kt-widget19__labels">
                                                    <a href="#" class="btn btn-label-light-o2 btn-bold btn-sm ">Running since 12:30PM</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="kt-portlet__body">
                                            <div class="kt-widget19__wrapper">
                                                <div class="kt-widget19__content">
                                                    ...
                                                    <div class="kt-widget19__stats">
																<span class="kt-widget19__number kt-font-success">
																	Running
																</span>
                                            ...
                                            <div class="kt-widget19__action">
                                                <a href="{{url('home')}}" class="btn btn-lg btn-label-brand btn-bold"><i class="fa fa-pause"></i>Control</a>
                                                <a class="btn btn-lg btn-secondary btn-bold">Manage</a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="kt-portlet kt-portlet--height-fluid kt-widget19">
                                        <div class="kt-portlet__body kt-portlet__body--fit kt-portlet__body--unfill">
                                            <div class="kt-widget19__pic kt-portlet-fit--top kt-portlet-fit--sides" style="min-height: 300px; background-image: url(/public/assets/media//products/product3.jpg)">
                                                ...
                                                <div class="kt-widget19__shadow"></div>
                                                <div class="kt-widget19__labels">
                                                    <a href="#" class="btn btn-label-light-o2 btn-bold btn-sm ">Stopped since 7 Sept. at 12:30PM</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="kt-portlet__body">
                                            <div class="kt-widget19__wrapper">
                                                <div class="kt-widget19__content">
                                                    ...
                                                    <div class="kt-widget19__stats">
																<span class="kt-widget19__number kt-font-warning">
																	Stopped
																</span>
                                                        <a href="#" class="kt-widget19__comment">
                                                            status
                                            ...
                                            <div class="kt-widget19__action">
                                                <a href="{{url('home')}}" class="btn btn-lg btn-label-brand btn-bold"><i class="fa fa-play"></i>Control</a>
                                                <a class="btn btn-lg btn-secondary btn-bold">Manage</a>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="kt-portlet__body">
                                            <div class="kt-widget19__wrapper">
                                                <div class="kt-widget19__content">
                                                    ...
                                                    <div class="kt-widget19__stats">
																<span class="kt-widget19__number kt-font-danger">
																	Disconnected
																</span>
                                                        <a href="#" class="kt-widget19__comment">
                                                            status
                                                ...
                                                <div class="kt-widget16__stats">
                                                    ...
                                                    <div class="kt-widget16__legends">
                                                        <div class="kt-widget16__legend">
                                                            ...
                                                            <span class="kt-widget16__stat">Running</span>
                                                        </div>
                                                        <div class="kt-widget16__legend">
                                                            <span class="kt-widget16__bullet kt-bg-warning"></span>
                                                            <span class="kt-widget16__stat">Stopped</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
